...
class SellingInvoiceItemTile extends StatefulWidget {
  final InvoiceItemModel item;
  final int index;

  const SellingInvoiceItemTile({
    super.key,
    required this.item,
    required this.index,
  });
  ...
  @override
  State<SellingInvoiceItemTile> createState() => _SellingInvoiceItemTileState();
}

class _SellingInvoiceItemTileState extends State<SellingInvoiceItemTile> {
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (product != null)
                        Text(
                          '${product.sellingPrice.toStringAsFixed(2)} ${AppStrings.egp}',
